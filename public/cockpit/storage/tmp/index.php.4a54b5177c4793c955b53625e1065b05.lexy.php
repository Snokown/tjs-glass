            ...
            <div each="{ singleton,idx in singletons }" show="{ ingroup(singleton.meta) && infilter(singleton.meta) }">
                ...
                <div class="uk-panel uk-panel-box uk-panel-card">
                    ...
                    <div class="uk-panel-teaser uk-position-relative">
                        ...
                        <a href="<?php $app->route('/singletons/form'); ?>/{ singleton.name }" class="uk-position-cover uk-flex uk-flex-middle uk-flex-center">
                    ...
                    <div class="uk-grid uk-grid-small">
                        ...
                        <div data-uk-dropdown="delay:300">
                            ...
                            <a class="uk-icon-cog" style="color: { (singleton.meta.color) }" href="<?php $app->route('/singletons/singleton'); ?>/{ singleton.name }" if="{ singleton.meta.allowed.singleton_edit }"></a>
